...
public class DataService {
	...
	public void startDB() {
		...
		//Cliente c2 = new Cliente(null, "Guido van Rossum", "(44) 222-1111", "vanrossum@webmail.com",enderecoWS);
		//Cliente c3 = new Cliente(null, "James Gosling", "(89) 222-4476", "gosling@webmail.com",enderecoWS);
